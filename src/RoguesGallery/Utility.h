...
//This sort of thing needs a primary namespace macro to be defined.
namespace RGL
{
	...
	template<class T> inline constexpr T operator & (T a, T b) { return (T)((int)a & (int)b); }
	//template<class T1, std::integral T2> inline constexpr T1 operator & (T1 a, T2 b) { return (T1)((int)a & (int)b); }
	//template<std::integral T1, class T2> inline constexpr T2 operator & (T1 a, T2 b) { return (T2)((int)a & (int)b); }
